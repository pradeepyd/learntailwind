    ...
    return (
        <div className='flex items-center justify-between py-3 px-4'>
            ...
            <div className="flex items-center gap-x-6 gap-y-4 text-[14px]">
                ...
                <button className='bg-[#2579F4] cursor-pointer text-white px-4  py-2 rounded-lg font-medium shadow-lg text-shadow-md  text-center hover:bg-[#2262C7]'>Get started</button>
            </div>
        </div>
    )
}
